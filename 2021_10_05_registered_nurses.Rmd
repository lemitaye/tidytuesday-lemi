---
title: "Analyzing Registered Nurses"
date: 2022-09-29
...
nurses %>% 
  ...
  ggplot(aes(year, n)) +
  geom_col() +
  labs(x = "# of registered nurses nationally")
...
nurses %>% 
  ...
  labs(y = "Median hourly wage", x = "Year", color = "State")
...
nurses %>% 
  ...
  labs(x = "% increase in # of registered nurses, 2000-2020",
       ...
       size = "# of nurses in 2000")


```


To be continued... (19:31)
